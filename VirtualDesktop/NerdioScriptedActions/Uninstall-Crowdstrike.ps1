...
.DESCRIPTION
	Pre Reqs:
	- Crowdstrike API Key with the following permissions for this customer:
		- Hosts (Read + Write)
...
$PublicUrl = $SecureVars.CsUninstallTool #The URI to a CsUninstallTool.exe file. Ensure this is accessible to the host VM.
